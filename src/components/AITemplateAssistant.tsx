...
interface AITemplateAssistantProps {
  ...
  onEditContent?: (instruction: string) => Promise<string>;
  userId: string;
}

export const AITemplateAssistant: React.FC<AITemplateAssistantProps> = ({ onClose, onSaveTemplate, onApplyDocData, onEditContent, userId }) => {
